...
[中文](./README.md) · [Live Demo](https://suge8.github.io/architecture-wiki/demo/)
...
The skill docs and generated pages are currently in Chinese ([why](docs/adr/0001-chinese-first-release.md)). Skill bodies are consumed by agents, and models are bilingual — an English-speaking user's agent runs the full workflow.
